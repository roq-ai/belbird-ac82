...
import { useBlogCategoryFindFirst, useRoqClient } from 'lib/roq';
...
function BlogCategoryViewPage() {
  ...
  const { data, error, isLoading } = useBlogCategoryFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('blog_category', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/blog-categories/edit/${id}`} passHref legacyBehavior>
                    <Button
