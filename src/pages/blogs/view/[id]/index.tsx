...
import { useBlogFindFirst, useRoqClient } from 'lib/roq';

import { BlogInterface } from 'interfaces/blog';
import { BlogCommentListPage } from 'pages/blog-comments';
...
function BlogViewPage() {
  ...
  const { data, error, isLoading } = useBlogFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Published At"
                  text={data?.published_at ? format(data?.published_at, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Contentimg" text={data?.contentimg} />
