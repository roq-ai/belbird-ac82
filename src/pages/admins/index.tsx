...
import { useRoqClient, useAdminFindManyWithCount } from 'lib/roq';
...
export function AdminListPage(props: AdminListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useAdminFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.admin.delete({ where: { id } });
      await mutate();
    } catch (error) {
