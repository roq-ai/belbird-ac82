  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to belbird, your one-stop platform for comprehensive company information, top-notch products, services, and insightful blogs. Experience the power of our dedicated admin panel for blog posting."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWJzaXRlfGVufDB8fHx8MTY5OTU1NDE0MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to belbird, your one-stop platform for comprehensive company information, top-notch products, services, and insightful blogs. Experience the power of our dedicated admin panel for blog posting.`}
            </Text>
            <Box
